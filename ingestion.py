...
from langchain_tavily import TavilyExtract, TavilyCrawl, tavily_extract, TavilyMap
...
# Ollama embeddings output 1536 dimensions by default (nomic-embed-text)
# Ensure this matches the Pinecone index dimension (1536)
